...
export const MatchSetup: React.FC = () => {
    ...
    const handleStartMatch = () => {
        ...
        addMatch({
            ...
            startTime: Date.now(),
            scores: {
                [player1.id]: { playerId: player1.id, totalPoints: 0, gamesWon: 0, innings: 0, defensiveShots: 0 },
                [player2.id]: { playerId: player2.id, totalPoints: 0, gamesWon: 0, innings: 0, defensiveShots: 0 }
            },
            innings: [],
            status: 'in_progress'
        });
